...
- [ ] **UI-01**: Web app is mobile-responsive and renders cleanly on a phone (Indian retail is mobile-first)
- [ ] **UI-02**: UI renders citations as superscript chips that expand to source-text snippets and link to the DRHP page
